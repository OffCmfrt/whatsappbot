    ...
    async processQueue(campaignId) {
        ...
        try {
            ...
            if (!recipients || recipients.length === 0) {
                ...
                this.isProcessing.delete(campaignId);  // Clean up Map entry
                this.activeQueues.delete(campaignId);  // Clean up any stale timeout ref
                return;
            }
            ...
            this.isProcessing.delete(campaignId);  // Clean up Map entry on error
            this.activeQueues.delete(campaignId);  // Clean up any stale timeout ref
        }
    }
